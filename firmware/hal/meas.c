...
void meas_cal_default(meas_cal_t *c, uint16_t kw) {
  ...
  meas_ch_t dc = { 2.0f * LSB * (3.8e6f + 6.8e3f) / 6.8e3f, 1.39f / LSB };   /* AMC1311 class: OUTP = 1.39 V + Vin/2 · 8×475 k / 6.8 k */
  meas_ch_t ac = { LSB / 0.205f * (3.8e6f + 11.5e3f) / 11.5e3f, 1.44f / LSB }; /* AMC1350 class: OUTP = 1.44 V + 0.41·Vin/2 · 11.5 k */
