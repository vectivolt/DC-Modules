...
# 🗄️ GD32 Pin Allocation (R3)

<sub>How the MCU allocation was first derived and audited; the live map is generated</sub>
...
<p>
  ...
  <img src="https://img.shields.io/badge/record-R3-6e7781?style=flat-square" alt="record: R3"/>
</p>

> [!NOTE]
> **Historical record — how the GD32 pin allocation was first derived and audited at R3, kept verbatim.**
> **Where it lives now:** the generated allocation, `calculations/control/umod-pinmap.mts` →
> `packages/common-components/umod-map.gen.ts` · [control-card scope](../control-card-scope.md).

> **Current state (E49):** the order code is **GD32G553VET7** (R5-I — VET6 was never a real
> ordering code; silicon and pinout unchanged) and the live allocation is GENERATED by
> `calculations/control/umod-pinmap.mts` → `packages/common-components/umod-map.gen.ts`.
> Notable post-R3 change: **R7-A swapped AIN9↔AIN11** (pins 25↔15) so the three PFC current
> senses own three INDEPENDENT comparators (I_A0→PC2/CMP7_IP, I_B0→PA3/CMP1_IP,
> I_C0→PC1/CMP2_IP) — the original allocation had B and C on the two inputs of CMP2.
> This document remains the R3 record of how the allocation was first derived and audited.
...
<div align="center">
<sub><a href="easyeda-transcription.md">← EasyEDA Transcription Notes</a> &nbsp;·&nbsp; <a href="../README.md">🧭 Documentation hub</a> &nbsp;·&nbsp; <a href="schematic-drawing-set.md">Schematic Drawing Set (card era) →</a></sub>
