...
| [`design-review-production.md`](design-review-production.md) | **adversarial production review** — verdict NO at review time; **rev C fix log: 15/15 blockers closed** (+HR/MR), gate = `review-checks.mjs` |
