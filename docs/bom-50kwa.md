...
pie showData title 50 kW air module — ₹ @10k by section
  ...
  "Vienna PFC stage" : 5942
  "AC input, surge and EMI filter" : 5738
  "Resonant tank, transformer and rectifiers" : 5474
  "Full-bridge LLC legs" : 3308
  "Output banks, S/P relays and output diode" : 2517
  "Split DC link and discharge" : 2348
  "Output and bank sensing" : 966
  "AC and bus sensing" : 956
  "Auxiliary supply and fans" : 605
  "Control card" : 310
  "CAN and HMI" : 161
...
|---|---:|---:|---:|---:|---:|
| AC input, surge and EMI filter | 47 | 17 | 5,738 | 14.9 % | 4,689 |
| Vienna PFC stage | 75 | 21 | 5,942 | 15.5 % | 4,668 |
| Split DC link and discharge | 39 | 15 | 2,348 | 6.1 % | 1,902 |
| AC and bus sensing | 99 | 22 | 956 | 2.5 % | 805 |
| AC-DC control interface | 14 | 7 | 23 | 0.1 % | 19 |
| Auxiliary supply and fans | 52 | 32 | 605 | 1.6 % | 479 |
| Full-bridge LLC legs | 75 | 15 | 3,308 | 8.6 % | 2,556 |
| Resonant tank, transformer and rectifiers | 44 | 14 | 5,474 | 14.3 % | 4,418 |
| Output banks, S/P relays and output diode | 51 | 13 | 2,517 | 6.6 % | 2,069 |
...
| 9 | `IND-LR-E70-50` | D2-50 rev F (E67): EXTERNAL resonant inductor 3.28 µH ±3% on 2× E70/33/32 PC95-class (TDK … | 1 | 953 | **953** | 762 | CUSTOM |
| 10 | `HF167F-250A-M` | power relay ≥80 A/line w/ mirror contact (precharge bypass carries full line current — … | 2 | 416 | **832** | 707 | REVIEW |
| 11 | `RELAY-PCB-150A-24V` | PCB power relay 120 A, 24 V coil, no mirror contact (E67 S/P matrix, switched at ZERO … | 3 | 224 | **672** | 571 | DIRECT |
| 12 | `FUSE-gG-690V-160A` | gG fuse 690 VAC, 22×58 frame (rating per SKU — audit F6: 80 A @30 kW; the 63 A part ran … | 3 | 208 | **624** | 530 | CLASS |
| 13 | `PP-33n-1200V` | 33 nF 1200 V PP resonant-duty film (E67 full-bridge tank: 7/9/11 in parallel at 30/40/50 … | 11 | 54 | **598** | 479 | CLASS |
| 14 | `DIODE-1600V-250A-MOD` | output series blocking diode 1600 V 250 A, insulated-base 2-terminal module (E67 InfyPower … | 1 | 496 | **496** | 422 | DIRECT |
...
<details><summary><b>AC input, surge and EMI filter</b> — ₹5,738 @10k · 47 parts · 17 lines</summary>
...
| `HF167F-250A-M` | power relay ≥80 A/line w/ mirror contact (precharge bypass carries full line current — CB-8; SKU class via … | KPRE1 KPRE2 | 2 | 416 | 832 | — | REVIEW |
...
<details><summary><b>Vienna PFC stage</b> — ₹5,942 @10k · 75 parts · 21 lines</summary>
...
<details><summary><b>Split DC link and discharge</b> — ₹2,348 @10k · 39 parts · 15 lines</summary>

| Part | What it is | Refs | Qty | ₹ / unit @10k | ₹ @10k | LCSC | Status |
|---|---|---|---:|---:|---:|---|---|
| `ELH-470u450` | 470 µF 450 V snap-in 105 °C, −40 °C category (A11 rev C cold floor −30 °C) (split bus: 415 V max per half) | CDT00 CDT01 CDT02 CDT03 CDT04 CDB00 CDB01 CDB02 … | 16 | 120 | 1,920 | — | CLASS |
...
<details><summary><b>Auxiliary supply and fans</b> — ₹605 @10k · 52 parts · 32 lines</summary>
...
<details><summary><b>Resonant tank, transformer and rectifiers</b> — ₹5,474 @10k · 44 parts · 14 lines</summary>
