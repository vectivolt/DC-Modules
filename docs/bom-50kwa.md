...
| | |
|---|---|
| **Build cost @10k** (India basis) | **₹40,688** · ₹814 / kW |
| **China RFQ target @10k** | **₹33,243** · ₹665 / kW — landed targets, not quotes |
| **1k · 5k · 100 pcs** | ₹50,111 · ₹44,670 · ₹65,363 |
| **Red-line / stretch** | ₹43,000 / ₹39,000 → ✅ under by ₹2,312 |
| **BOM lines · placed parts** | 179 lines · 743 parts (AC-DC 350 · DC-DC 316 · control card 77) |
...
pie showData title 50 kW air module — ₹ @10k by section
  ...
  "Vienna PFC stage" : 6182
  "AC input, surge and EMI filter" : 5992
  "Resonant tank, transformer and rectifiers" : 5535
  "Full-bridge LLC legs" : 4572
  "Split DC link and discharge" : 2780
  "Output banks, S/P relays and output diode" : 2517
  "Output and bank sensing" : 975
...
|---|---:|---:|---:|---:|---:|
| AC input, surge and EMI filter | 47 | 22 | 5,992 | 14.7 % | 4,897 |
| Vienna PFC stage | 90 | 22 | 6,182 | 15.2 % | 4,858 |
| Split DC link and discharge | 35 | 15 | 2,780 | 6.8 % | 2,246 |
| AC and bus sensing | 105 | 24 | 958 | 2.4 % | 806 |
| AC-DC control interface | 16 | 8 | 24 | 0.1 % | 20 |
| Auxiliary supply and fans | 57 | 34 | 611 | 1.5 % | 483 |
| Full-bridge LLC legs | 101 | 28 | 4,572 | 11.2 % | 3,582 |
| Resonant tank, transformer and rectifiers | 47 | 16 | 5,535 | 13.6 % | 4,467 |
| Output banks, S/P relays and output diode | 51 | 13 | 2,517 | 6.2 % | 2,069 |
| Output and bank sensing | 69 | 16 | 975 | 2.4 % | 828 |
| DC-DC control interface | 13 | 7 | 107 | 0.3 % | 90 |
| CAN and HMI | 35 | 19 | 163 | 0.4 % | 140 |
| Control card | 77 | 29 | 323 | 0.8 % | 281 |
| Mechanics, thermal and assembly | — | 12 | 9,950 | 24.5 % | 8,475 |
| **Module** | | | **40,688** | 100 % | **33,243** |
...
<details><summary><b>Vienna PFC stage</b> — ₹6,182 @10k · 90 parts · 22 lines</summary>
...
<details><summary><b>Split DC link and discharge</b> — ₹2,780 @10k · 35 parts · 15 lines</summary>
...
| `B4B-PH-K-S` | fan header 4-way (the fan p/n must accept 3.3 V PWM) | JFAN1 JFAN2 JFAN3 JFAN4 | 4 | 5 | 19 | C131334 | ORDERABLE |
...
| `HV732BTTD4753F` | 475 kΩ 1206 1% anti-surge (HV divider) | RFPD1 RFPD2 RFPD3 RFPD4 | 4 | 1 | 4 | C4121673 | ORDERABLE |
...
<details><summary><b>Full-bridge LLC legs</b> — ₹4,572 @10k · 101 parts · 28 lines</summary>
...
<details><summary><b>Resonant tank, transformer and rectifiers</b> — ₹5,535 @10k · 47 parts · 16 lines</summary>
...
<details><summary><b>Output and bank sensing</b> — ₹975 @10k · 69 parts · 16 lines</summary>
...
| Fans 120×38 PWM (3 front + 1 rear, 3.3 V-PWM p/n, dual-ball L10 ≥70 kh, IP55, −30…+70 °C; IP55 premium at RFQ · ELECTRICAL CLASS: ≤ 0.6 A at … | 4 | 1,120 | 974 | 828 |
...
| ![CLASS](https://img.shields.io/badge/-CLASS-d19a00?style=flat-square) | 97 | the rating is the specification; purchasing selects to the spec line |
...
**Open REVIEW lines:** `GC4D20120D` · `HFE18V/NB90 or TE EV200 class` · `HFE18V/NB90 or TE EV200 class` · `ISO5V-RFC-6K` · `GD32G553VET7` · `LED-2DIG-0.56CC` · `PS122WF4702T4E` · `TACT-6x6` — each carries its action note in `lcsc-map.mjs`.
