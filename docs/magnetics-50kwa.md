...
|---|---|---|---|---|---|---|
| **Saturation · flux margin** | L 47.6 µH @ 129.5 A ≥ 45 µH | B̂ 22 % of hot Bsat · 146 mT at the F.11 kill ≤ 217 | B̂ 39 % of hot Bsat · family worst 44 % of Bsat(130 °C) | 257 mT = 71.1 % of Bsat(130 °C) at the current limit ≤ 75 % | DM 0.46 T ≤ 0.6 · CM 17 mT | no saturation below 244 A pk (1.25 × F.01) |
| **Core loss · thermal runaway** | Fe 7.5 W at the 50 kHz ripple | Fe 30.6 W · runaway margin 159 K | Fe 47 W · runaway margin 120 K | runaway margin 121 K · cold start self-warms | nanocrystalline at line frequency — negligible | — |
...
| **Faults · abnormal operation** | bypass closure 280 A pk (F.01 blanked) · OC race Δi 72 A ≤ 116 | F.11 kill 302.5 A pk — flux in row 1 | one fan out 87 °C · bond lost 123 °C → EOL soak | hard short V24 5.31 A · V15 5.07 A before the latch | surge clamped before the chokes | F.01 race 266.4 A ≤ 311.5 A ceiling |
...
| `magnetics-envelope` | 50kwa 2×E70 N 5 · 3.29 µH max · web2 · R core→wall 0.77 · winding→core 0.77 K/W | core corner SER250-full-bus764 203 kHz B̂ 88 mT Fe 30.6 W · copper corner SER250-full-bus764 203 kHz Cu 45 W · hot-spot 109 °C @55 °C (SER250-full-bus764; core 101 °C / winding 109 °C) / 101 °C @75 °C derated (SER250-full-bus764) · +25 % Rth 118 °C · runaway margin 159 K · B̂ 22 % of hot Bsat | ✅ |
| `magnetics-envelope` | D2-BOND-LOST · 50kwa | one face lost (web1) → 118 °C @55 / 111 °C @75 · +25 % 135 °C → survives | ℹ️ |
| `stress-audit` | 50kwa external Lr Bpk | 82 mT at Lmax 3.29 µH × 120 A rms class vs 110 mT line (N=5 on 2× E70/33/32 — E67 D2 rev F) | ✅ |
...
| `current-coordination` | 50kwa external Lr flux: operating + fault | Lmax 3.29 µH (2×E70 N 5): 88 mT at the worst simulated peak (≤110) · 146 mT at the F.11 kill peak ≤ 60 % Bsat(130 °C) 217 mT | ✅ |
...
| Gate | Check | Result | |
|---|---|---|:---:|
| `magnetics-envelope` | 50kwa 3×E70 2 cells 4:4∥4 (2 foils) · web2 · R core→wall 0.52 · winding→core 0.58 K/W | core corner ENV500-55 87 kHz B̂ 158 mT Fe 47 W · copper corner SER250-full-bus764 203 kHz Cu 71.3 W · hot-spot 116 °C @55 °C (SER250-full-bus764; core 94 °C / winding 116 °C) / 102 °C @75 °C derated (ENV500-55) · +25 % Rth 127 °C · runaway margin 120 K · B̂ 39 % of hot Bsat | ✅ |
| `magnetics-envelope` | D3-BOND-LOST · 50kwa | one face lost (web1) → 123 °C @55 / 116 °C @75 · +25 % 139 °C → survives | ℹ️ |
| `magnetics-envelope` | BOND · 50kwa | D3 (potting) + D2 (potting) cannot survive a lost bond → EOL bonded thermal soak is mandatory (docs/dfm-production.md) | ℹ️ |
...
| `current-coordination` | 50kwa window-comparator kill + observability | \|Ip\| crosses F.11 1.5 µs after the short → kill peak 302.5 A (+1 µs, ×1.2 ≤ 540 A on 0.3 Ω) · monitor peak +3 µs 504.4 A ×1.05 in rail · window 0.99/2.31 V | ✅ |
| `current-coordination` | 50kwa LLC FET pulse class at the FAST kill peak | +0.5 µs 301.7 A ≤ 0.9 × 265 A × 2 die = 477 A (HRTIMER filter 0b0011 ≈140 ns + comparator 50 ns + driver 60 ns + t_d,off 50 ns ≈ 0.3 µs → 0.5 µs budget) · conservative +1 µs 302.5 A (57 % of I_DM) · monitor +3 µs 504.4 A · SG2M023120LJ RFQ acceptance I_DM ≥ 265 A (E69a line, parts-db) — the C3M0021120K proxy lists 200 A; BINDING RFQ LINE for the 30 kW single die | ✅ |
