...
|---|---|---|---|---|---|---|
| **Saturation · flux margin** | L 47.6 µH @ 129.5 A ≥ 45 µH | B̂ 22 % of hot Bsat · 163 mT at the F.11 kill ≤ 217 | B̂ 39 % of hot Bsat · family worst 44 % of Bsat(130 °C) | 257 mT = 71.1 % of Bsat(130 °C) at the current limit ≤ 75 % | DM 0.46 T ≤ 0.6 · CM 17 mT | no saturation below 244 A pk (1.25 × F.01) |
| **Core loss · thermal runaway** | Fe 7.5 W at the 50 kHz ripple | Fe 32.8 W · runaway margin 158 K | Fe 47.5 W · runaway margin 118 K | runaway margin 121 K · cold start self-warms | nanocrystalline at line frequency — negligible | — |
...
| **Winding temperature** | 92 °C @ 55 °C ≤ 120 | 109 °C @ 55 °C ≤ 125 · +25 % Rth 119 ≤ 155 | 116 °C @ 55 °C ≤ 125 · +25 % Rth 127 ≤ 155 | ΔT ≤ 45 K at 110 W (type test) | ΔT 38 K ≤ 45 | ΔT ≤ 30 K at class current |
| **Current rating · density** | 3.55 A/mm² ≤ 5.5 | 116 A rms · 182.8 A pk · 5.1 A/mm² | P 116 A rms (8.3 A/mm²) · each half 57.1 A rms (12.7 A/mm²) — loss-governed | ≤ 4.67 A pk primary · V24 2.4 A · V15 1.2 A | 3.66 A/mm² ≤ 5.6 | 150 A line · 150 A rms class resonant |
...
| **Leakage · coupling** | — | carries the tank Lr (± 3 %) | cell 0.09 µH · Lr stack ± 4.3 % ≤ 5 % | 1-D 1.7 µH · accept ≤ 4 µH | 6–12 µH, measured at first article | — |
...
| **Current imbalance · circulating current** | one choke per phase | — | 7.9 % between cells in LOW mode; HIGH mode balanced | — | 3-wire, Σi = 0 | — |
...
| **Faults · abnormal operation** | bypass closure 280 A pk (F.01 blanked) · OC race Δi 72 A ≤ 116 | F.11 kill 329.7 A pk — flux in row 1 | one fan out 88 °C · bond lost 124 °C → EOL soak | hard short V24 5.31 A · V15 5.07 A before the latch | surge clamped before the chokes | F.01 race 266.4 A ≤ 311.5 A ceiling |
...
| `magnetics-envelope` | 50kwa D2 with one of 4 fans dead at 55 °C inlet (F.25 derate 50 %) | airflow ×0.75 · web 73 °C · air 62 °C → hot-spot 88 °C (SER250-full-bus764) ≤ 135 °C derated line · runaway margin 172 K ≥ 25 — core loss does not derate, copper does | ✅ |
...
| Current rating | primary **116 A rms** / **182.8 A pk** · each secondary half **57.1 A rms** / 88.0 A pk at the worst simulated corner · 83–203 kHz |
...
| `magnetics-envelope` | 50kwa D3 with one of 4 fans dead at 55 °C inlet (F.25 derate 50 %) | airflow ×0.75 · web 73 °C · air 62 °C → hot-spot 88 °C (ENV500-55) ≤ 135 °C derated line · runaway margin 130 K ≥ 25 — core loss does not derate, copper does | ✅ |
| `magnetics-envelope` | 50kwa D3 cell current share with a ±7 % Lm mismatch between the two cells | LOW mode (banks parallel): the heavier cell's secondary rises 7.9 % rms at ENV500-55 · its copper at the worst LOW corner 53 W (PS150-Imax) ≤ the 71.3 W copper corner the thermal proof already carries · HIGH mode (banks in series) balances by equal charge | ✅ |
