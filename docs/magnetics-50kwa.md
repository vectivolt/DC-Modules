...
| **Current rating · density** | 3.55 A/mm² ≤ 5.5 | 116.1 A rms · 182.6 A pk · 5.1 A/mm² | P 116.1 A rms (8.3 A/mm²) · each half 57.0 A rms (12.7 A/mm²) — loss-governed | ≤ 4.67 A pk primary · V24 2.4 A · V15 1.2 A | 3.66 A/mm² ≤ 5.6 | 150 A line · 150 A rms class resonant |
...
| Gate | Check | Result | |
|---|---|---|:---:|
| `current-coordination` | 50kwa threshold ≥ 1.2× simulated worst tank peak | 220 A pk vs 182.6 A (SER250-full-bus764) → 1.2× | ✅ |
