...
| **D2** | external resonant inductor · `IND-LR-E70-40` | 1 | 2 × E70/33/32 PC95-class, N 5, litz 10000×0.05 mm, 3.99 µH ± 3 % | 862 | 862 | CUSTOM |
...
| **CT** | resonant current transformer · `CT-RES-1:100-150A` | 1 | 1:100, 150 A rms class (tank class 100 A = 67 %), burden 0.36 Ω | 132 | 132 | CLASS |
...
flowchart LR
  ...
  BUS --> FB["full-bridge LLC"] --> TANK["Cr 9 × 33 nF + D2 3.99 µH"] --> D3["D3 cells × 2<br/>4:4∥4 · primaries in series"] --> BK["banks A + B"]
...
|---|---|---|---|---|---|---|
| **Saturation · flux margin** | L 63 µH @ 104 A ≥ 61 µH | B̂ 22 % of hot Bsat · 157 mT at the F.11 kill ≤ 217 | B̂ 39 % of hot Bsat · family worst 44 % of Bsat(130 °C) | 257 mT = 71.1 % of Bsat(130 °C) at the current limit ≤ 75 % | DM 0.59 T ≤ 0.6 · CM 27 mT | no saturation below 194 A pk (1.25 × F.01) |
| **Core loss · thermal runaway** | Fe 6.4 W at the 50 kHz ripple | Fe 31.3 W · runaway margin 157 K | Fe 47.2 W · runaway margin 116 K | runaway margin 116 K · cold start self-warms | nanocrystalline at line frequency — negligible | — |
| **Copper · skin · proximity** | Cu 26 + 13.3 W · ripple Fr 44.5 | Fr 2.49 · Cu 27.4 W · MKF ×0.49 | foil Fr 1.17 · Cu 46.1 W · MKF ×1.32 | primary Fr 1.05 (sandwich) | 17 W per choke | — |
...
| **Current rating · density** | 2.84 A/mm² ≤ 5.5 | 93.4 A rms · 147.9 A pk · 5.1 A/mm² | P 93.4 A rms (6.7 A/mm²) · each half 45.9 A rms (10.2 A/mm²) — loss-governed | ≤ 4.67 A pk primary · V24 2 A · V15 1.1 A | 3.67 A/mm² ≤ 5.6 | 150 A line · 150 A rms class resonant |
...
| **Resonance · switching transients** | filter–loop modulus margin ≥ 0.59 | ZVS on all four switches at every corner except 3 phase-shift corners, where the weak leg turns on with 231–389 V of residual — the thermal grid and the firmware junction observer carry that loss | secondary ring 611 V = 51 % of the 1200 V rectifiers | switch 1344 V = 79 % with the clamp · SRF ≥ 650 kHz | — | — |
| **Faults · abnormal operation** | bypass closure 218 A pk (F.01 blanked) · OC race Δi 50 A ≤ 70 | F.11 kill 261.2 A pk — flux in row 1 | one fan out 89 °C · bond lost 106 °C → EOL soak | hard short V24 5.31 A · V15 5.07 A before the latch | surge clamped before the chokes | F.01 race 204.9 A ≤ 225 A ceiling |
...
| Electrical acceptance (100 %) | L₀ @ 0.1 V / 100 kHz **106–135 µH (125 nom — 5 × AL 37 at N = 26; the 116u in the part number is a class name, not this nominal)** · **L @ 104 A pk ≥ 61 µH** (pulse method) · Rdc **≤ 4.55 mΩ @ 25 °C (build 3.97) and within ±5 % of the lot median** — one open strand fails the lot window |
...
| Gate | Check | Result | |
|---|---|---|:---:|
| `stress-audit` | 40kw biased-L floor [catalog AL] | L0 125 µH → 63 µH @104 A ≥ 61 (D1-40 rev B: N=26±1 sized on the CATALOG AL — a geometric-Ae model sizes N=23, which misses this floor on the real core) | ✅ |
...
| `conductor-audit` | 40kw bundle 13× 1.6 mm, 26 T on 5×T79 | MLT 227 mm (Magnetics table, K 42 %) · 50 Hz 72.9 A → 27.2 W · 50 kHz ripple 7.83 A rms at Fr 43.2 (Ferreira 65.1 × 2-D 0.664; a flat untwisted bundle computes 6.2 W) → 13.6 W · Cu 40.8 W hot — a two-layer Dowell (m = 2) model reads 3.6 W ripple copper [d1-fd N26·nw13·d1.6·x5·L17/9] | ✅ |
| `conductor-audit` | 40kw production Rdc row @25 °C catches open strands | build 3.97 mΩ · row ≤4.55 mΩ (14 % above; worst good part 4.35; 2 strands open 4.7) · lot window ±5 % vs one open strand +8.3 % — a row set by round numbers instead of the build passes a part with a third of its strands open | ✅ |
| `temp-critique` | 40kw OC→ceiling time / 3 µs adder | L(155 A)=39.8 µH (AL−8%) · Δi(3 µs)=50 A ≤ ceiling−threshold 70 A · ceiling reached in 4 µs — CT stays observing until the HRTIMER kill lands (2–3 µs budget) | ✅ |
| `current-coordination` | 40kw precharge-bypass closure at 90 % of line peak · F.01 blanked, D1, link | 218 A pk through D1 and the rectifier (above F.01 155 A) · D1 falls to 27 µH from 115 µH at the peak — soft powder saturation for 1.4 ms, winding +0 K adiabatic · bus 605 → 725 V ≤ 860 V OVP · F.01 blanked 60 ms ≥ relay 25 + bounce 5 + pulse 1.4 ms, no PFC enable inside (fsm.c) | ✅ |
| `current-coordination` | 40kw rectifier diode surge at bypass closure | 27 A²s per diode vs 50 % of the RFQ line IFSM ≥ 250 A (10 ms half-sine → 313 A²s) | ✅ |
| `current-coordination` | 40kw bypass relay make and gG fuse at closure | make 218 A pk at ≤ 67 V across the contacts vs the RFQ make line 280 A pk (≥ 1.25×) · fuse 27 A²s ≤ 10 % of the gG pre-arc 4000 A²s — no melting, no ageing | ✅ |
| `mkf-crosscheck` | 40kw D1 Rdc @25 °C from MKF's toroid winding | 3.88 vs build 3.97 mΩ (-2.3 %) — 5 × T 79/48/17, N 26, 13 × 1.6 mm · acceptance ±5 % | ✅ |
| `mkf-crosscheck` | 40kw D1 Kool Mµ 26 DC-bias roll-off (MKF material data, 100 °C) vs the engines' fit | floor 104 A = 173 Oe: MKF 61.6 % vs engine 50.4 % · inrush 218 A = 363 Oe: MKF 29.5 % vs engine 23.2 % — the engines' L(i) sits at or below the material data, so every biased-L floor and the inrush peak are conservative | ✅ |
...
|---|---|
| Inductance | **3.99 µH ± 3 %** @ 140 kHz, 0.1 V (100 %) |
| Current rating | **93.4 A rms** at the copper corner (203 kHz) · **147.9 A pk** at the worst simulated corner · 261.2 A pk for ≤ 1 µs at the F.11 kill — flux at that peak is a proof row |
...
| Gap | distributed centre-leg gap **Σ ≈ 12.0 mm in 12 segments**, every segment ≤ 1.0 mm, outer legs mated — ground to the AL that gives 3.99 µH at N 5; Σ is the fringing-corrected first-grind guide (MKF) |
...
| `magnetics-envelope` | 40kw 2×E70 N 5 · 4.11 µH max · web2 · R core→wall 0.77 · winding→core 0.76 K/W | core corner SER250-full-bus764 203 kHz B̂ 89 mT Fe 31.3 W · copper corner SER250-full-bus764 203 kHz Cu 27.4 W · hot-spot 100 °C @55 °C (SER250-full-bus764; core 97 °C / winding 100 °C) / 103 °C @75 °C derated (SER250-full-bus764) · +25 % Rth 107 °C · runaway margin 157 K · B̂ 22 % of hot Bsat | ✅ |
| `magnetics-envelope` | D2-BOND-LOST · 40kw | one face lost (web1) → 112 °C @55 / 115 °C @75 · +25 % 127 °C → survives | ℹ️ |
| `stress-audit` | 40kw external Lr Bpk | 85 mT at Lmax 4.11 µH × 100 A rms class vs 110 mT line (N=5 on 2× E70/33/32 — D2 rev F) | ✅ |
| `stress-audit` | 40kw external Lr litz J | 10000×0.05 mm litz (19.6 mm²): J 5.1 A/mm² ≤ 5.6 at the 100 A class | ✅ |
| `conductor-audit` | 40kw 2×E70 N 5, litz 10000×0.05 @203 kHz | MLT 218 mm · Rdc 0.98 mΩ @25 °C (row ≤1.1) · Sullivan Fr 2.49 → Rac 3.14 mΩ hot (row ≤3.45) → Cu 27.4 W at 93.4 A rms (SER250-full-bus764) — thermal proof: magnetics-envelope | ✅ |
| `current-coordination` | 40kw external Lr flux: operating + fault | Lmax 4.11 µH (2×E70 N 5): 89 mT at the worst simulated peak (≤110) · 157 mT at the F.11 kill peak ≤ 60 % Bsat(130 °C) 217 mT | ✅ |
...
**Build and hold points.** (1) Grind or space the centre-leg gap in segments of ≤ 1.0 mm toward the AL that gives 3.99 µH at N 5; glue,
...
|---|---|
| Ratio · magnetizing | **4:4∥4 exactly** (P : S1 ∥ S2, S1 and S2 paralleled at the header) · Lm **21.75 µH ± 7 %** per cell @ 10 kHz, 0.1 V · **the two cells of a module ship as a MATCHED PAIR, L_m within ± 3 % of each other** (gapped together, labelled A / B) — their primaries are in series on one C_r, so they divide the applied volt-seconds by their magnetizing impedance: a ± 7 % pair reads 513 / 481 V on the two banks at 1000 V series and + 7 % flux on the higher-L_m cell |
...
| Current rating | primary **93.4 A rms** / **147.9 A pk** · each secondary half **45.9 A rms** / 71.2 A pk at the worst simulated corner · 77–203 kHz (82 kHz lowest steady state · 77 kHz = the firmware's transient floor, 0.55·f_r) |
...
| Gate | Check | Result | |
|---|---|---|:---:|
| `magnetics-envelope` | 40kw 3×E70 2 cells 4:4∥4 (2 foils) · web2 · R core→wall 0.52 · winding→core 0.58 K/W | core corner ENV500-55 87.4 kHz B̂ 158 mT Fe 47.2 W · copper corner SER250-full-bus764 203 kHz Cu 46.1 W · hot-spot 102 °C @55 °C (SER250-full-bus764; core 89 °C / winding 102 °C) / 103 °C @75 °C derated (ENV500-55) · +25 % Rth 108 °C · runaway margin 116 K · B̂ 39 % of hot Bsat | ✅ |
| `magnetics-envelope` | D3-BOND-LOST · 40kw | one face lost (web1) → 106 °C @55 / 120 °C @75 · +25 % 135 °C → not survivable — screened by the EOL bonded thermal soak | ℹ️ |
...
| `conductor-audit` | 40kw cell profiled-litz primary 3536×0.071 mm | Sullivan (interleaved k 0.25) Fr 1.25 → 19.1 W at 93.4 A rms | ✅ |
...
| `mkf-crosscheck` | 40kw D3 cell with MKF copper ×1.32 in the magnetics-envelope network | hot-spot 110 °C @55 °C (core 92 / winding 110) vs 125 · 103 °C @75 °C derated vs 135 · +25 % Rth 119 °C vs 155 · runaway margin 115 K vs 25 | ✅ |
...
| Gate | Check | Result | |
|---|---|---|:---:|
| `stress-audit` | 40kw winding J [engine] | D7 20 mm² → 3.67 A/mm² ≤ 5.6 (no AC-side DM choke) | ✅ |
...
| `stress-audit` | 40kw common-mode flux from the switch-node edges | Cp 200 pF × 425 V → 6 V on the 14.1 nF Y trio for ½ × 50 kHz across 8 T × 281 mm² = 27 mT ≤ 10 % of the hot Bsat (1.155 T) — the 150 Hz midpoint component closes through pF and is negligible | ✅ |
...
| `mkf-crosscheck` | 40kw D7 L_cm from MKF's Nanoperm 30000 permeability (10 kHz, 100 °C, −30 %) | µ 29517 → 2.29 mH on A_Fe 281 mm² / le 204 mm, N 8 vs engine 2.27 mH (+0.8 %) and the ≥ 2.0 mH line — the cased T 80/50/25 is not in the MKF shape database, so this checks the material basis, not the geometry | ✅ |
...
| Gate | Check | Result | |
|---|---|---|:---:|
| `current-coordination` | 40kw threshold ≥ 1.2× simulated worst line peak | 155 A pk vs 127.1 A (330-full-dip50-5ms-recovery: ripple on the soft-saturated D1 at lot AL−8 %, bus 830, incl. 30 %/50 % dips + 20° jump with the firmware's 1.05× reference clamp) → 1.22× | ✅ |
...
| `current-coordination` | 40kw threshold ≥ 1.2× simulated worst tank peak | 180 A pk vs 147.9 A (SER250-full-bus764) → 1.22× | ✅ |
| `current-coordination` | 40kw window-comparator kill + observability | \|Ip\| crosses F.11 1.4 µs after the short → kill peak 261.2 A (+1 µs, ×1.2 ≤ 450 A on 0.36 Ω) · monitor peak +3 µs 416.2 A ×1.05 in rail · window 1/2.3 V | ✅ |
| `current-coordination` | 40kw LLC FET pulse class at the FAST kill peak | +0.5 µs 251.3 A ≤ 0.9 × 265 A × 2 die = 477 A (comparator 50 ns + HRTIMER filter 0b0011 37 ns + driver 60 ns + t_d,off 50 ns ≈ 0.2 µs after the comparator input crosses → 0.5 µs budget) · conservative +1 µs 261.2 A (49 % of I_DM) · monitor +3 µs 416.2 A · SG2M023120LJ RFQ acceptance I_DM ≥ 265 A (parts-db) — the C3M0021120K proxy lists 200 A; BINDING RFQ LINE for the 30 kW single die | ✅ |
