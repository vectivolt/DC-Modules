...
# 🧾 50 kW Liquid Module BOM

<sub>Every line of the 50 kW liquid module — cost by schematic section, SKU-specific parts and sourcing status</sub>
...
> [!NOTE]
> **Purpose** — the complete bill of materials of the **50 kW liquid module**: what it costs, where the money goes by schematic
> section, the parts that make this SKU different, and every line item with its sourcing status. **Generated by
> `calculations/cost/bom-gen.mjs` on every battery run — do not hand-edit.** Machine-readable lines: `calculations/out/bom-50kw.csv`.

## At a glance

| | |
|---|---|
| **Build cost @10k** (India basis) | **₹40,481** · ₹810 / kW |
| **China RFQ target @10k** (E69f) | **₹33,182** · ₹664 / kW — landed targets, not quotes |
| **1k · 5k · 100 pcs** | ₹49,680 · ₹44,411 · ₹64,299 |
| **Red-line / stretch** | ₹43,000 / ₹39,000 → ✅ under by ₹2,519 |
| **BOM lines · placed parts** | 149 lines · 646 parts (AC-DC 322 · DC-DC 276 · control card 48) |
| **Built to our drawings** | 9 custom lines — specifications on the [50 kW liquid magnetics page](magnetics-50kw.md) |
| **Open sourcing decisions** | 10 REVIEW lines |

## Where the money goes

```mermaid
pie showData title 50 kW liquid module — ₹ @10k by section
  "Mechanics, thermal and assembly" : 12046
...
|---|---:|---:|---:|---:|---:|
| AC input, surge and EMI filter | 47 | 17 | 5,738 | 14.2 % | 4,689 |
| Vienna PFC stage | 75 | 21 | 5,942 | 14.7 % | 4,668 |
| Split DC link and discharge | 39 | 15 | 2,348 | 5.8 % | 1,902 |
| AC and bus sensing | 99 | 22 | 956 | 2.4 % | 805 |
| AC-DC control interface | 14 | 7 | 23 | 0.1 % | 19 |
| Auxiliary supply and fans | 48 | 31 | 586 | 1.4 % | 462 |
| Full-bridge LLC legs | 75 | 15 | 3,308 | 8.2 % | 2,556 |
| Resonant tank, transformer and rectifiers | 44 | 14 | 5,474 | 13.5 % | 4,418 |
...
| Mechanics, thermal and assembly | — | 14 | 12,046 | 29.8 % | 10,276 |
| **Module** | | | **40,481** | 100 % | **33,182** |
...
These lines replace the shared-cell default on the 50 kW liquid module (`skuOverrides` in `parts-db.mjs`); everything else is the common design.
...
<details><summary><b>Auxiliary supply and fans</b> — ₹586 @10k · 48 parts · 31 lines</summary>
...
|---|---:|---|
| ![ORDERABLE](https://img.shields.io/badge/-ORDERABLE-2ea44f?style=flat-square) | 57 | a specific catalogue part, verified against the rating |
