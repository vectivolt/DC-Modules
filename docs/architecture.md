...
> [decision register](assumptions.md) (E1–E63), and every number reproduces from `calculations/run-all.sh`.
...
timeline
  ...
  Coordination · E60–E63 : power-solved simulation, trip classes, AC copper, harsh-environment parity, documentation standard, teardown benchmark, gap levers
```
