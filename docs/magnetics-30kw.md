...
| **D2** | external resonant inductor · `IND-LR-E70-30` | 1 | 2 × E70/33/32 PC95-class, N 5, litz 8000×0.05 mm, 5.00 µH ± 3 % | 772 | 772 | CUSTOM |
...
| **CT** | resonant current transformer · `CT-RES-1:100-100A` | 1 | 1:100, 100 A rms class (tank class 78 A = 78 %), burden 0.47 Ω | 132 | 132 | CLASS |
...
flowchart LR
  ...
  BUS --> FB["full-bridge LLC"] --> TANK["Cr 7 × 33 nF + D2 5.00 µH"] --> D3["D3 cells × 2<br/>6:6∥6 · primaries in series"] --> BK["banks A + B"]
...
|---|---|---|---|---|---|---|
| **Saturation · flux margin** | L 76.9 µH @ 78 A ≥ 75 µH | B̂ 21 % of hot Bsat · 158 mT at the F.11 kill ≤ 217 | B̂ 39 % of hot Bsat · family worst 44 % of Bsat(130 °C) | 257 mT = 71.1 % of Bsat(130 °C) at the current limit ≤ 75 % | DM 0.44 T ≤ 0.6 · CM 27 mT | no saturation below 150 A pk (1.25 × F.01) |
| **Core loss · thermal runaway** | Fe 4.7 W at the 50 kHz ripple | Fe 28.1 W · runaway margin 160 K | Fe 31.8 W · runaway margin 116 K | runaway margin 116 K · cold start self-warms | nanocrystalline at line frequency — negligible | — |
...
| **Winding temperature** | 87 °C @ 55 °C ≤ 120 | 94 °C @ 55 °C ≤ 125 · +25 % Rth 104 ≤ 155 | 106 °C @ 55 °C ≤ 125 · +25 % Rth 114 ≤ 155 | ΔT ≤ 45 K at 110 W (type test) | ΔT 20 K ≤ 45 | ΔT ≤ 30 K at class current |
| **Current rating · density** | 3.05 A/mm² ≤ 5.5 | 70.5 A rms · 112.6 A pk · 5 A/mm² | P 70.5 A rms (5.9 A/mm²) · each half 34.6 A rms (12.4 A/mm²) — loss-governed | ≤ 4.67 A pk primary · V24 1.6 A · V15 1 A | 2.79 A/mm² ≤ 5.6 | 100 A line · 100 A rms class resonant |
...
| **Leakage · coupling** | — | carries the tank Lr (± 3 %) | cell 0.252 µH · Lr stack ± 4.5 % ≤ 5 % | 1-D 1.7 µH · accept ≤ 4 µH | 6–12 µH, measured at first article | — |
...
| **Resonance · switching transients** | filter–loop modulus margin ≥ 0.59 | ZVS on all four switches at every corner except 3 phase-shift corners, where the weak leg turns on with 84–291 V of residual — the thermal grid and the firmware junction observer carry that loss | secondary ring 611 V = 51 % of the 1200 V rectifiers | switch 1344 V = 79 % with the clamp · SRF ≥ 650 kHz | — | — |
| **Faults · abnormal operation** | bypass closure 200 A pk (F.01 blanked) · OC race Δi 46 A ≤ 64 | F.11 kill 210.3 A pk — flux in row 1 | one fan out 88 °C · bond lost 110 °C → EOL soak | hard short V24 5.31 A · V15 5.07 A before the latch | surge clamped before the chokes | F.01 race 165.3 A ≤ 184.1 A ceiling |
...
| `stress-audit` | 30kw 3×T79 N 39 9×1.6 mm · web1 | hot-spot at the 330 VAC continuous corner [computed] — Cu 22.4 W @50 Hz + 14.5 W ripple (6.3 A rms, Fr 48.9 = Ferreira 71.3 × 2-D 0.686) + Fe 4.7 W → hot-spot 87 °C @55 °C (winding 85 °C, air 65 °C, web/plate 80 °C, 28 W into it) · 97 °C @75 °C derated · +25 % Rth 89 °C · limits 120/130/145 °C [d1-fd N39·nw9·d1.6·x3·L21/15/3] | ✅ |
...
| `conductor-audit` | 30kw bundle 9× 1.6 mm, 39 T on 3×T79 | MLT 161 mm (Magnetics table, K 44 %) · 50 Hz 54.7 A → 23.4 W · 50 kHz ripple 6.3 A rms at Fr 47.5 (Ferreira 69.2 × 2-D 0.686; a flat untwisted bundle computes 7.7 W) → 14.8 W · Cu 38.2 W hot — a two-layer Dowell (m = 2) model reads 3.6 W ripple copper [d1-fd N39·nw9·d1.6·x3·L21/15/3] | ✅ |
| `conductor-audit` | 30kw production Rdc row @25 °C catches open strands | build 6.08 mΩ · row ≤6.9 mΩ (13 % above; worst good part 6.57; 2 strands open 7.82) · lot window ±5 % vs one open strand +12.5 % — a row set by round numbers instead of the build passes a part with a third of its strands open | ✅ |
| `temp-critique` | 30kw OC→ceiling time / 3 µs adder | L(120 A)=45.4 µH (AL−8%) · Δi(3 µs)=46 A ≤ ceiling−threshold 64 A · ceiling reached in 4 µs — CT stays observing until the HRTIMER kill lands (2–3 µs budget) | ✅ |
...
|---|---|
| Inductance | **5.00 µH ± 3 %** @ 140 kHz, 0.1 V (100 %) |
| Current rating | **70.5 A rms** at the copper corner (203 kHz) · **112.6 A pk** at the worst simulated corner · 210.3 A pk for ≤ 1 µs at the F.11 kill — flux at that peak is a proof row |
...
| Gap | distributed centre-leg gap **Σ ≈ 9.5 mm in 10 segments**, every segment ≤ 1.0 mm, outer legs mated — ground to the AL that gives 5.00 µH at N 5; Σ is the fringing-corrected first-grind guide (MKF) |
...
| Gate | Check | Result | |
|---|---|---|:---:|
| `magnetics-envelope` | 30kw D2 + D3 leakage stack inside the simulated Lr tolerance | D3 cell S1–P–S2 leakage 0.252 µH × 2 + 0.1 µH loop → D2 5 µH of Lr 5.6 µH · worst-case stack ±4.5 % (D2 ±3 % + leakage ±20 %) vs ±5 % simulated | ✅ |
| `magnetics-envelope` | 30kw 2×E70 N 5 · 5.15 µH max · web2 · R core→wall 0.77 · winding→core 0.75 K/W | core corner SER250-full-bus764 202.9 kHz B̂ 85 mT Fe 28.1 W · copper corner SER250-full-bus764 202.9 kHz Cu 15.1 W · hot-spot 94 °C @55 °C (SER250-full-bus764; core 94 °C / winding 93 °C) / 100 °C @75 °C derated (SER250-full-bus764) · +25 % Rth 104 °C · runaway margin 160 K · B̂ 21 % of hot Bsat | ✅ |
| `magnetics-envelope` | D2-BOND-LOST · 30kw | one face lost (web1) → 104 °C @55 / 111 °C @75 · +25 % 120 °C → survives | ℹ️ |
| `stress-audit` | 30kw external Lr Bpk | 83 mT at Lmax 5.15 µH × 78 A rms class vs 110 mT line (N=5 on 2× E70/33/32 — D2 rev F) | ✅ |
| `stress-audit` | 30kw external Lr litz J | 8000×0.05 mm litz (15.7 mm²): J 5 A/mm² ≤ 5.6 at the 78 A class | ✅ |
| `conductor-audit` | 30kw 2×E70 N 5, litz 8000×0.05 @203 kHz | MLT 216 mm · Rdc 1.21 mΩ @25 °C (row ≤1.35) · Sullivan Fr 1.96 → Rac 3.04 mΩ hot (row ≤3.35) → Cu 15.1 W at 70.5 A rms (SER250-full-bus764) — thermal proof: magnetics-envelope | ✅ |
| `current-coordination` | 30kw external Lr flux: operating + fault | Lmax 5.15 µH (2×E70 N 5): 85 mT at the worst simulated peak (≤110) · 158 mT at the F.11 kill peak ≤ 60 % Bsat(130 °C) 217 mT | ✅ |
| `magnetics-envelope` | 30kw D2 with one of 3 fans dead at 55 °C inlet (F.25 derate 50 %) | airflow ×0.67 · web 74 °C · air 63 °C → hot-spot 86 °C (SER250-full-bus764) ≤ 135 °C derated line · runaway margin 174 K ≥ 25 — core loss does not derate, copper does | ✅ |
...
**Build and hold points.** (1) Grind or space the centre-leg gap in segments of ≤ 1.0 mm toward the AL that gives 5.00 µH at N 5; glue,
...
|---|---|
| Ratio · magnetizing | **6:6∥6 exactly** (P : S1 ∥ S2, S1 and S2 paralleled at the header) · Lm **28 µH ± 7 %** per cell @ 10 kHz, 0.1 V · **the two cells of a module ship as a MATCHED PAIR, L_m within ± 3 % of each other** (gapped together, labelled A / B) — their primaries are in series on one C_r, so they divide the applied volt-seconds by their magnetizing impedance: a ± 7 % pair reads 513 / 481 V on the two banks at 1000 V series and + 7 % flux on the higher-L_m cell |
...
| Current rating | primary **70.5 A rms** / **112.6 A pk** · each secondary half **34.6 A rms** / 54.2 A pk at the worst simulated corner · 77–203 kHz (82 kHz lowest steady state · 77 kHz = the firmware's transient floor, 0.55·f_r) |
...
| Leakage | per cell, both halves shorted, 140 kHz, after VPI: **0.252 µH ± 30 %** — measured and labelled |
...
| Gate | Check | Result | |
|---|---|---|:---:|
| `magnetics-envelope` | 30kw 2×E70 2 cells 6:6∥6 · web2 · R core→wall 0.77 · winding→core 0.88 K/W | core corner ENV500-55 87.5 kHz B̂ 159 mT Fe 31.8 W · copper corner SER250-full-bus764 202.9 kHz Cu 45.8 W · hot-spot 106 °C @55 °C (SER250-full-bus764; core 90 °C / winding 106 °C) / 103 °C @75 °C derated (ENV500-55) · +25 % Rth 114 °C · runaway margin 116 K · B̂ 39 % of hot Bsat | ✅ |
| `magnetics-envelope` | D3-BOND-LOST · 30kw | one face lost (web1) → 110 °C @55 / 116 °C @75 · +25 % 128 °C → not survivable — screened by the EOL bonded thermal soak | ℹ️ |
| `magnetics-envelope` | BOND · 30kw | D3 + D3 (potting) cannot survive a lost bond → EOL bonded thermal soak is mandatory (docs/dfm-production.md) | ℹ️ |
...
| `conductor-audit` | 30kw cell profiled-litz primary 3850×0.063 mm | Sullivan (interleaved k 0.25) Fr 1.32 → 15.7 W at 70.5 A rms | ✅ |
...
| `magnetics-envelope` | 30kw D3 with one of 3 fans dead at 55 °C inlet (F.25 derate 50 %) | airflow ×0.67 · web 74 °C · air 63 °C → hot-spot 88 °C (ENV500-55) ≤ 135 °C derated line · runaway margin 127 K ≥ 25 — core loss does not derate, copper does | ✅ |
...
| Gate | Check | Result | |
|---|---|---|:---:|
| `stress-audit` | 30kw winding J [engine] | D7 20 mm² → 2.79 A/mm² ≤ 5.6 (no AC-side DM choke) | ✅ |
...
| Gate | Check | Result | |
|---|---|---|:---:|
| `current-coordination` | 30kw threshold ≥ 1.2× simulated worst line peak | 120 A pk vs 97 A (330-full-dip50-5ms-recovery: ripple on the soft-saturated D1 at lot AL−8 %, bus 830, incl. 30 %/50 % dips + 20° jump with the firmware's 1.05× reference clamp) → 1.24× | ✅ |
...
| `current-coordination` | 30kw threshold ≥ 1.2× simulated worst tank peak | 140 A pk vs 112.6 A (SER250-full-bus764) → 1.24× | ✅ |
| `current-coordination` | 30kw window-comparator kill + observability | \|Ip\| crosses F.11 1.5 µs after the short → kill peak 210.3 A (+1 µs, ×1.2 ≤ 344.7 A on 0.47 Ω) · monitor peak +3 µs 321.4 A ×1.05 in rail · window 0.99/2.31 V | ✅ |
| `current-coordination` | 30kw LLC FET pulse class at the FAST kill peak | +0.5 µs 198.1 A ≤ 0.9 × 265 A × 1 die = 238.5 A (comparator 50 ns + HRTIMER filter 0b0011 37 ns + driver 60 ns + t_d,off 50 ns ≈ 0.2 µs after the comparator input crosses → 0.5 µs budget) · conservative +1 µs 210.3 A (79 % of I_DM) · monitor +3 µs 321.4 A · SG2M023120LJ RFQ acceptance I_DM ≥ 265 A (parts-db) — the C3M0021120K proxy lists 200 A; BINDING RFQ LINE for the 30 kW single die | ✅ |
