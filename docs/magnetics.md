...
| Insulation · hipot | pri↔sec REINFORCED (TIW + ≥ 3 barrier-tape layers per shield) · 100 % pri↔sec 4.25 kV DC, windings → bonded-face foil 2.5 / 1.5 kV DC · PD ≥ 2.0 kV extinction (insulation-coordination; E68 single-die 30 kW bridge) | PD ≥ 2.0 kV (E69a) | PD ≥ 2.0 kV |
