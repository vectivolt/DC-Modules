...
| Hipot · PD | **100 %: pri↔sec ≥ 4.25 kV DC 1 s** (safety-critical, witnessed, logged) · P → bonded-face foil 2.5 kV DC · S → foil 1.5 kV DC · PD type test + 5 / lot: extinction **≥ 2.0 kV pk** (E68), ≤ 10 pC after 1.2× pre-stress | same, ≥ 1.9 kV | same, **≥ 2.0 kV** |
...
| Insulation · hipot | basic insulation to PE through former + spacer + VPI class H · 100 % winding → bonded-face foil 2.5 kV DC · PD 5 / lot ≥ 2.0 kV extinction (E68) | ≥ 1.9 kV | ≥ 2.0 kV |
