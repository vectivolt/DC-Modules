...
| **China RFQ target @10k** | **₹25,924** · ₹864 / kW — landed targets, not quotes |
| **2U construction scenario** | ₹29,691 · China target ₹24,360 — flagged estimate, not the design basis |
...
|---|---:|---:|---:|---:|---:|
| AC input, surge and EMI filter | 47 | 17 | 3,764 | 11.9 % | 3,070 |
...
| 2 | `CMC-3PH-2mH-SKU` | 3-phase CM choke 2 mH nanocrystalline, winding rated to the SKU line current (D7). … | 2 | 1,062 | **2,123** | 1,699 | CUSTOM |
| 3 | `GC4D20120D` | SiC JBS 1200 V 40 A-class TO-247-2, SINGLE die, 2-terminal (exact p/n at RFQ). ACCEPTANCE: … | 22 | 96 | **2,112** | 1,584 | REVIEW |
| 4 | `XFMR-LLC-CELL-2E70-30` | D3-30 rev D: full-bridge LLC transformer CELL (2 per module, primaries in SERIES → n = 2 … | 2 | 935 | **1,870** | 1,590 | CUSTOM |
| 5 | `ELH-470u500` | 470 µF **500 V** snap-in aluminium electrolytic, 105 °C, −40 °C category, 35 mm land … | 10 | 148 | **1,480** | 1,184 | CLASS |
| 6 | `SG2M023120LJ` | SiC MOSFET 1200 V 23 mΩ TO-247-4L — full-bridge LLC switch, clip-mounted; tanks.mjs sets … | 4 | 312 | **1,248** | 936 | SECOND-SOURCE |
| 7 | `PP-1u-1100` | 1 µF 1100 V film (bridge commutation at the DC-DC entry; 830 V ≤ 76 % of the class). THE … | 16 | 54 | **870** | 696 | CLASS |
| 8 | `SIC-750V-20mR` | SiC MOSFET 750 V 20 mΩ class TO-247-4 (Vienna common-source pair, one die per position) | 6 | 144 | **864** | 648 | CLASS |
| 9 | `IND-LR-E70-30` | D2-30 rev F: EXTERNAL resonant inductor 5.00 µH ±3% on 2× E70/33/32 PC95-class (TDK former … | 1 | 772 | **772** | 618 | CUSTOM |
| 10 | `PP-2u2-630` | 2.2 µF 630 V PP film, ripple-rated (bank rectifier film: ≤ 10 A rms per part of the … | 18 | 36 | **648** | 518 | CLASS |
...
| 12 | `NSI6611` | iso gate driver 10 A, DESAT / Miller clamp (CLAMP pin wired) / UVLO, SOIC-16 | 7 | 68 | **476** | 405 | ORDERABLE |
| 13 | `AMC1311DWVR` | iso voltage-sense amp 0–2 V input (bus / bank / output senses). On the 1311 class the … | 5 | 92 | **460** | 391 | ORDERABLE |
| 14 | `ISO-GBIAS-15-1W` | isolated gate-bias module **+15 V / −3 V**, 1 W class (Vienna channels: ONE common-source … | 8 | 55 | **440** | 374 | CLASS |
| 15 | `HF167F/024-HATF(764)` | power relay ≥80 A/line with a mirror contact — the precharge bypass carries full line … | 2 | 208 | **416** | 354 | DIRECT |
...
|---|---|---:|---|
| `SIC-750V-20mR` | QA0A · QA0B · QB0A · QB0B · QC0A · QC0B | 144 | 750 V 20 mΩ class, single die per position, clip-mounted (grid T_j 112 °C) — RFQ target; ACCEPTANCE IDM ≥ 210 A @25 °C (165 A F.01 fault peak) |
| `FUSE-gG-690V-80A` | F1 · F2 · F3 | 84 | gG fuse 80 A 690 VAC, 22×58 frame (30 kW AC input, 55.9 A worst continuous). The holder must be the matching 22×58 base |
| `HF167F-80A-M` | KPRE1 · KPRE2 | 208 | power relay ≥80 A/line with a mirror contact — the precharge bypass carries full line current (SKU class via override). §K line: contact-gap withstand and … |
| `CMC-3PH-2mH-SKU` | CMC1 · CMC2 · RSHO · DA0CM · CA0CM · RA0CM … | 1,062 | D7-30 rev B: T 80/50/25, A_Fe ≥ 281 mm², 3×8 T 20 mm², 9.9 W, ΔT 20 K — second source to the Schaffner catalog part |
| `CMC-3PH-2mH-SKU` | CMC1 · CMC2 · RSHO · DA0CM · CA0CM · RA0CM … | 1,062 | 3-phase CM choke 2 mH nanocrystalline, winding rated to the SKU line current (D7). ACCEPTANCE: L_cm ≥ 2 mH @10 kHz AND ≥ 1.0 mH @150 kHz, ≥ 80 % of it held with … |
| `SHUNT-50MV-100A` | CMC1 · CMC2 · RSHO · DA0CM · CA0CM · RA0CM … | 96 | manganin shunt, 50 mV at rated current, Kelvin 4-terminal — the value follows the order code per SKU: 0.500 / 0.376 / 0.299 mΩ at the 100 / 133 / 167 A codes |
| `C1206-330p-1kV-C0G` | C1HOS1 · C1LOS1 · C2HOS1 · C2LOS1 | 7 | 330 pF 1 kV C0G 1206 LLC turn-off snubber (tanks.mjs cs @30 kW) |

## Line items by section

<details><summary><b>AC input, surge and EMI filter</b> — ₹3,764 @10k · 47 parts · 17 lines</summary>
...
| `HF167F/024-HATF(764)` | power relay ≥80 A/line with a mirror contact — the precharge bypass carries full line current (SKU class via … | KPRE1 KPRE2 | 2 | 208 | 416 | — | DIRECT |
...
| `FUSE-gG-690V-80A` | gG fuse 80 A 690 VAC, 22×58 frame (30 kW AC input, 55.9 A worst continuous). The holder must be the matching … | F1 F2 F3 | 3 | 84 | 252 | — | CLASS |
...
<details><summary><b>Split DC link and discharge</b> — ₹1,838 @10k · 29 parts · 12 lines</summary>

| Part | What it is | Refs | Qty | ₹ / unit @10k | ₹ @10k | LCSC | Status |
|---|---|---|---:|---:|---:|---|---|
| `ELH-470u500` | 470 µF **500 V** snap-in aluminium electrolytic, 105 °C, −40 °C category, 35 mm land (split DC link). The 500 … | CDT00 CDT01 CDT02 CDT03 CDT04 CDB00 CDB01 CDB02 … | 10 | 148 | 1,480 | — | CLASS |
...
| `ACX-1100` | line CT 2500:1, 100 A, ±1%, Ø14.6 mm window, 4 kV hipot, PCB pins. Rated for a 33 Ω burden, so the 27 Ω fitted … | CTA0 CTB0 CTC0 | 3 | 52 | 156 | — | DIRECT |
...
| `RC1206FR-0722RL` | 22 Ω line-CT burden 1% (F.01 120 A pk = 2.71 V; observable to 184 A through the D1 soft-saturation 3 µs race; … | RA0B RB0B RC0B | 3 | 1 | 3 | — | CLASS |
...
| Part | What it is | Refs | Qty | ₹ / unit @10k | ₹ @10k | LCSC | Status |
|---|---|---|---:|---:|---:|---|---|
| `SG2M023120LJ` | SiC MOSFET 1200 V 23 mΩ TO-247-4L — full-bridge LLC switch, clip-mounted; tanks.mjs sets the dies per position … | Q1H Q1L Q2H Q2L | 4 | 312 | 1,248 | C5713523 | SECOND-SOURCE |
...
| `ISO-GBIAS-15-1W` | isolated gate-bias module **+15 V / −3 V**, 1 W class (Vienna channels: ONE common-source pair per channel at … | PS1H PS1L PS2H PS2L | 4 | 55 | 220 | — | CLASS |
...
| `STUD-M8` | M8 stud terminal | JDCP JDCN JPEB | 3 | 22 | 67 | — | CLASS |
| `C1206-330p-1kV-C0G` | 330 pF 1 kV C0G 1206 LLC turn-off snubber (tanks.mjs cs @30 kW; 470 pF and above close the weak leg's ZVS … | C1HOS1 C1LOS1 C2HOS1 C2LOS1 | 4 | 7 | 29 | — | CLASS |
...
<details><summary><b>Resonant tank, transformer and rectifiers</b> — ₹4,712 @10k · 43 parts · 15 lines</summary>

| Part | What it is | Refs | Qty | ₹ / unit @10k | ₹ @10k | LCSC | Status |
|---|---|---|---:|---:|---:|---|---|
| `XFMR-LLC-CELL-2E70-30` | D3-30 rev D: full-bridge LLC transformer CELL (2 per module, primaries in SERIES → n = 2 overall) — 2× … | T1A T1B | 2 | 935 | 1,870 | — | CUSTOM |
...
| `IND-LR-E70-30` | D2-30 rev F: EXTERNAL resonant inductor 5.00 µH ±3% on 2× E70/33/32 PC95-class (TDK former B66372A2000), N=5, … | L1R | 1 | 772 | 772 | — | CUSTOM |
| `PP-33n-1200V` | 33 nF 1200 V PP resonant-duty film (full-bridge tank: 7/9/11 in parallel at 30/40/50 kW → ≤ 10.3 A rms per cap … | C1R0 C1R1 C1R2 C1R3 C1R4 C1R5 C1R6 | 7 | 54 | 381 | — | CLASS |
| `CT-RES-1:100-100A` | resonant CT 1:100, 100 A rms class, 20–250 kHz, pass-through — the tank conductor is the primary, so … | CT1 | 1 | 132 | 132 | — | CLASS |
...
| `R2512-0R47-1W-1%` | 0.47 Ω 1% 1 W 2512 resonant-CT burden (full bridge: F.11 140 A pk = 0.66 V above AVMID; observable to 345 A, … | R1CT | 1 | 3 | 3 | — | CLASS |
...
| Part | What it is | Refs | Qty | ₹ / unit @10k | ₹ @10k | LCSC | Status |
|---|---|---|---:|---:|---:|---|---|
| `PP-2u2-630` | 2.2 µF 630 V PP film, ripple-rated (bank rectifier film: ≤ 10 A rms per part of the 30/39/49 A rms 2·fsw … | CFA0 CFA1 CFA2 CFA3 CFA4 CFA5 CFA6 CFA7 … | 18 | 36 | 648 | — | CLASS |
...
| `DIODE-1600V-150A-MOD` | output series blocking diode 1600 V 150 A, insulated-base 2-terminal module — back-feed and reverse-battery … | DOUT | 1 | 336 | 336 | — | DIRECT |
...
| `SHUNT-50MV-100A` | manganin shunt, 50 mV at rated current, Kelvin 4-terminal — the value follows the order code per SKU: 0.500 / … | RSHO | 1 | 96 | 96 | — | CLASS |
...
| TIM/insulators/fasteners (clip mount: 0.635 mm Al2O3 insulator + spring clip + grease under each of 27 TO-247 dies, mount.mjs 0.8 K/W) | 1 | 480 | 418 | 355 |
| Magnetics bond kit: 3 W/mK silicone gap pads on BOTH yoke faces of the two D3 cells and the D2 to the upper/lower extrusion webs + clamp … | 1 | 220 | 191 | 163 |
...
| Conformal coating (acrylic, both boards + card) | 1 | 320 | 278 | 237 |
| Assembly + calibration + EOL test | 1 | 1,900 | 1,653 | 1,653 |
| **Total** | | **10,071** | **8,762** | **7,461** |
...
| TIM/insulators/fasteners (clip mount, 27 dies) | 1 | 480 | 418 |
...
| ![DIRECT](https://img.shields.io/badge/-DIRECT-1a9fb3?style=flat-square) | 5 | a vendor-direct order code (Talema, Hongfa, Mean Well class) |
| ![CLASS](https://img.shields.io/badge/-CLASS-d19a00?style=flat-square) | 84 | the rating is the specification; purchasing selects to the spec line |
