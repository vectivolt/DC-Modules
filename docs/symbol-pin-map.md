...
verified pin-by-pin against the design intent (`calculations/kicad5-verify.mjs`, 100% across the six SHIP targets).
...
**118 part families · 30 carry a logical→physical remap · 697 pins.**

| `0R` | FBCARDA | _(same)_ | 1=pin1 2=pin2 |  |
| `1.6` | R1CT | _(same)_ | 1=pin1 2=pin2 |  |
...
| `21.5` | RA0B | _(same)_ | 1=pin1 2=pin2 |  |
...
| `74HC02` | UEXCL | _(same)_ | 1=Y1 2=A1 3=B1 4=Y2 5=A2 6=B2 7=GND 8=A3 9=B3 10=Y3 11=A4 12=B4 13=Y4 14=VCC |  |
...
| `ACX-1100` | CTA0 | _(same)_ | 1=S1 2=S2 | REVIEW |
...
| `AS-404` | CT1 | _(same)_ | 1=S1 2=S2 | REVIEW |
| `B3M010C075Z` | QA0A | 1=G 2=D 3=S -=DS | 4=G 1=D 2=S 3=DS | C5713521 |
| `BZT52-C15` | DZAUX | -=A -=C | 2=A 1=C |  |
| `CER-25W-160R-AX` | RDIS0 | _(same)_ | 1=A 2=B |  |
| `CER-25W-33R-AX` | RPRE1 | _(same)_ | 1=A 2=B |  |
...
| `HFE82V-20-M-CLASS` | KPREA | -=COIL1 -=COIL2 -=COM1 -=NO1 -=COM2 -=NO2 | 1=COIL1 8=COIL2 4=COM1 6=NO1 5=COM2 3=NO2 | REVIEW |
| `HFE82V-M-CLASS` | KSER | -=COIL1 -=COIL2 -=COM1 -=NO1 -=COM2 -=NO2 | 1=COIL1 8=COIL2 4=COM1 6=NO1 5=COM2 3=NO2 | REVIEW |
...
| `MICROFIT3-40` | JICA | _(same)_ | 1=W1 2=W2 3=W3 4=W4 5=W5 6=W6 7=W7 8=W8 9=W9 10=W10 11=W11 12=W12 13=W13 14=W14 15=W15 16=W16 17=W17 18=W18 19=W19 20=W20 21=W21 22=W22 23=W23 24=W24 25=W25 26=W26 27=W27 28=W28 29=W29 30=W30 31=W31 32=W32 33=W33 34=W34 35=W35 36=W36 37=W37 38=W38 39=W39 40=W40 |  |
| `NCP1252D` | UAUX | _(same)_ | 1=FB 2=BO 3=CS 4=RT 5=GND 6=DRV 7=VCC 8=SS |  |
| `NSI1042-DSWR` | UCAN | 4=VDD1 2=GND1 2=GND1 3=RXD 1=TXD 5=VDD2 8=GND2 8=GND2 8=GND2 6=CANL 7=CANH | 1=VDD1 2=GND1 8=GND1 3=RXD 6=TXD 16=VDD2 9=GND2 10=GND2 15=GND2 12=CANL 13=CANH |  |
...
| `PMP-30KW-MODULE` | MOD1 | _(same)_ | 1=L1 2=L2 3=L3 4=PE 5=OUTP 6=OUTN 7=CANH 8=CANL 9=SGND 10=SHLD |  |
| `PSU-15V-DIN-WDR` | PSU1 | _(same)_ | 1=L 2=N 3=PE 4=V15P 5=V15N |  |
| `QA01C` | PSQD | 1=VIN 2=GND -=+VO -=0V | 1=VIN 2=GND 7=+VO 6=0V | C2757491 |
| `QA01C-18` | PSA0G | 1=VIN 2=GND -=+VO -=0V -=-VO | 1=VIN 2=GND 7=+VO 6=0V 5=-VO |  |
...
| `SHUNT-50MV-100A` | RSHO | _(same)_ | 1=A 2=B 3=KA 4=KB |  |
