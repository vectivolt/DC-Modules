...
| | |
|---|---|
| **Build cost @10k** (India basis) | **₹35,970** · ₹899 / kW |
| **China RFQ target @10k** (E69f) | **₹29,418** · ₹735 / kW — landed targets, not quotes |
| **2U construction scenario** (E69e) | ₹34,034 · China target ₹27,833 — flagged estimate, not the design basis |
| **1k · 5k · 100 pcs** | ₹44,270 · ₹39,497 · ₹57,605 |
| **Red-line / stretch** | ₹33,000 / ₹29,000 → ⚠️ over by ₹2,970 |
| **BOM lines · placed parts** | 171 lines · 686 parts (AC-DC 333 · DC-DC 298 · control card 55) |
| **Built to our drawings** | 9 custom lines — specifications on the [40 kW magnetics page](magnetics-40kw.md) |
| **Open sourcing decisions** | 11 REVIEW lines |
...
pie showData title 40 kW module — ₹ @10k by section
  ...
  "Vienna PFC stage" : 5517
  "Resonant tank, transformer and rectifiers" : 5275
  "Full-bridge LLC legs" : 4284
  "AC input, surge and EMI filter" : 4080
  "Output banks, S/P relays and output diode" : 2149
  "Split DC link and discharge" : 2144
...
|---|---:|---:|---:|---:|---:|
| AC input, surge and EMI filter | 47 | 17 | 4,080 | 11.3 % | 3,337 |
| Vienna PFC stage | 81 | 27 | 5,517 | 15.3 % | 4,349 |
| Split DC link and discharge | 35 | 12 | 2,144 | 6 % | 1,732 |
| AC and bus sensing | 100 | 23 | 956 | 2.7 % | 806 |
| AC-DC control interface | 16 | 8 | 24 | 0.1 % | 20 |
| Auxiliary supply and fans | 54 | 34 | 604 | 1.7 % | 478 |
| Full-bridge LLC legs | 97 | 28 | 4,284 | 11.9 % | 3,352 |
| Resonant tank, transformer and rectifiers | 45 | 16 | 5,275 | 14.7 % | 4,259 |
| Output banks, S/P relays and output diode | 47 | 11 | 2,149 | 6 % | 1,763 |
| Output and bank sensing | 61 | 14 | 954 | 2.7 % | 810 |
| DC-DC control interface | 13 | 7 | 107 | 0.3 % | 90 |
| CAN and HMI | 35 | 19 | 163 | 0.5 % | 140 |
| Control card | 55 | 28 | 319 | 0.9 % | 277 |
| Mechanics, thermal and assembly | — | 12 | 9,393 | 26.1 % | 8,004 |
| **Module** | | | **35,970** | 100 % | **29,418** |
...
| 6 | `ELH-470u500` | 470 µF **500 V** snap-in 105 °C, −40 °C category (A11 rev C cold floor −30 °C). E81 … | 12 | 148 | **1,776** | 1,421 | CLASS |
...
| 8 | `PP-1u-1100` | 1 µF 1100 V film (bridge commutation at the DC-DC entry — HR-1: 830 V ≤ 76%). E81 … | 16 | 54 | **870** | 696 | CLASS |
| 9 | `PP-2u2-630` | 2.2 µF 630 V PP film, ripple-rated (E67 rectifier-side bank film: ≤ 10 A rms per part of … | 24 | 36 | **864** | 691 | CLASS |
| 10 | `IND-LR-E70-40` | D2-40 rev F (E67): EXTERNAL resonant inductor 3.99 µH ±3% on 2× E70/33/32 PC95-class (TDK … | 1 | 862 | **862** | 689 | CUSTOM |
...
| 12 | `FUSE-gG-690V-125A` | gG fuse 690 VAC, 22×58 frame (rating per SKU — audit F6: 80 A @30 kW; the 63 A part ran … | 3 | 168 | **504** | 428 | CLASS |
| 13 | `PP-33n-1200V` | 33 nF 1200 V PP resonant-duty film (E67 full-bridge tank: 7/9/11 in parallel at 30/40/50 … | 9 | 54 | **490** | 392 | CLASS |
| 14 | `HF167F/024-HATF(764)` | power relay ≥80 A/line w/ mirror contact (precharge bypass carries full line current — … | 2 | 240 | **480** | 408 | DIRECT |
| 15 | `NSI6611` | iso gate driver 10 A, DESAT/Miller(CLAMP wired, CB-12)/UVLO, SOIC-16 | 7 | 68 | **476** | 405 | ORDERABLE |
...
| `SHUNT-50MV-133A` | RSHO | 112 | 0.376 mΩ (50 mV / 133 A) — E76 value-align |
...
| `IND-LR-E70-40` | L1R | 862 | D2-40 rev F (E67): EXTERNAL resonant inductor 3.99 µH ±3% on 2× E70/33/32 PC95-class (TDK former B66372A2000), N=5, litz 10000×0.05 mm (19.6 mm²) compacted … |
...
| `C1206-680p-1kV-C0G` | C1HOS1 · C1HOS2 · C1LOS1 · C1LOS2 · C2HOS1 · C2HOS2 … | 7 | 680 pF 1 kV C0G 1206 LLC turn-off snubber (tanks.mjs cs @40 kW — the knee: k_off 5.20 nJ/(V·A), 83.8 % of 1200 V, 379 ns. 1 nF was run and REJECTED here, … |
...
<details><summary><b>Vienna PFC stage</b> — ₹5,517 @10k · 81 parts · 27 lines</summary>
...
<details><summary><b>Split DC link and discharge</b> — ₹2,144 @10k · 35 parts · 12 lines</summary>

| Part | What it is | Refs | Qty | ₹ / unit @10k | ₹ @10k | LCSC | Status |
|---|---|---|---:|---:|---:|---|---|
| `ELH-470u500` | 470 µF **500 V** snap-in 105 °C, −40 °C category (A11 rev C cold floor −30 °C). E81 (F-C-6/F-C-14): the 450 V … | CDT00 CDT01 CDT02 CDT03 CDT04 CDB00 CDB01 CDB02 … | 12 | 148 | 1,776 | — | CLASS |
...
<details><summary><b>Full-bridge LLC legs</b> — ₹4,284 @10k · 97 parts · 28 lines</summary>
...
<details><summary><b>Resonant tank, transformer and rectifiers</b> — ₹5,275 @10k · 45 parts · 16 lines</summary>
...
| `IND-LR-E70-40` | D2-40 rev F (E67): EXTERNAL resonant inductor 3.99 µH ±3% on 2× E70/33/32 PC95-class (TDK former B66372A2000), … | L1R | 1 | 862 | 862 | — | CUSTOM |
...
| `SHUNT-50MV-133A` | manganin shunt, 50 mV at rated current, Kelvin 4-terminal (0.500 / 0.376 / 0.299 mΩ at the 100 / 133 / 167 A … | RSHO | 1 | 112 | 112 | — | CLASS |
...
| ![REVIEW](https://img.shields.io/badge/-REVIEW-bc4e9c?style=flat-square) | 11 | a tracked open decision, closed before release |

**Open REVIEW lines:** `GC4D20120D` · `ISO5V-RFC-6K` · `QA01C-15` · `GD32G553VET7` · `QA02C-15` · `QA02C-15` · `QA02C-15` · `QA02C-15` · `PS122WF4702T4E` · `LED-2DIG-0.56CC` · `TACT-6x6` — each carries its action note in `lcsc-map.mjs`.
