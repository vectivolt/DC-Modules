...
export const LCSC = {
  ...
  "SICJBS-1200-40":    { lcsc: "C7435099", mpn: "GC4D20120D",   status: "ORDERABLE", note: "GC4D20120D 1200 V 34 A SiC JBS" },
  ...
  "HFE82V-M-CLASS":    { status: "DIRECT", mpn: "HFE82V-<rating>W/1000-24-HA-C5-1", spec: "HV power relay w/ mirror contact — bank/output switching",
  ...
  "HFE82V-20-M-CLASS": { status: "DIRECT", mpn: "HFE82V-20W/1000-24-HA-C5-1 (confirm frame)", spec: "20 A 1000 VDC relay w/ auxiliary contact — pre-insertion",
                         note: "2026-09-06 R8 FIX. Replaces HFE9-10A-1kV-M on KPREA/KPREB. The Hongfa HFE9 is a miniature LATCHING relay: 250 VAC max switching (not 1 kV), latching 50 ms set/reset (the ULN2803 drive assumes monostable), and contact form 1A/1B with NO auxiliary contact — while the drawing wires COM2/NO2 for the RELAY_FB_KPRE* readback. It fails all three requirements, so the DRAWING is right and the part number was wrong. Same HFE82V family already used for KSER/KPARA/KPARB/KOUT, at the 20 A rating that suits pre-insertion duty rather than the 200-400 A bank rating. Ordering code follows the bank part: HFE82V-20W/1000-24-HA-C5-1 (1000 VDC load, 24 V coil matching V24, H = 1 Form A main, A = 1 Form A auxiliary). CONFIRM before ordering: that the 20 A rating exists in the HFE82V catalogue with the HA option, and whether it is a PCB or stud/harness part — the bank parts are M6 screw terminals with a flying coil/aux harness, so the land may not be a PCB footprint. Price 300/1k is an ESTIMATE scaled from the 460 bank part, not a quote." },
  ...
  "ELH-470u450":       { status: "CLASS", spec: "470 µF 450 V snap-in, 105 °C, DC-link grade, −40 °C category temperature (A11 rev C: −30 °C operating floor; many 450 V snap-in series stop at −25 °C — confirm per series at RFQ)" },
  ...
  "R2512-1R2-1W-1%":   { status: "CLASS", spec: "1.2 Ω 1% 1 W 2512 (30 kW resonant-CT burden — E60 F.11 85 A pk)" },
  "R2512-0R91-1W-1%":  { status: "CLASS", spec: "0.91 Ω 1% 1 W 2512 (40 kW resonant-CT burden — E60 F.11 115 A pk)" },
  "R2512-0R75-2W-1%":  { status: "CLASS", spec: "0.75 Ω 1% 2 W 2512 (50 kW resonant-CT burden — E60 F.11 145 A pk)", note: "Bourns CRM/Yageo SR anti-surge families" },
  ...
  "QA01C-18":          { status: "REVIEW", mpn: "QA01C-18", note: "MORNSUN +18/-3 V gate-bias module — O-11 (E5/E6 want +18/-4) stays the §K decision; R5-F input-range cross-reg at EVT" },
  "PP-33n-1200V":      { status: "CLASS", spec: "33 nF 1200 V PP resonant-duty film (40 kW tank; Vrms-vs-f >=460 V @140 kHz)", note: "candidates: CDE 942C20P33K / Faratronic resonant PP" },
  "PP-27n-1200V":      { status: "CLASS", spec: "27 nF 1200 V PP resonant-duty film (50 kW tank; Vrms-vs-f >=530 V @140 kHz)", note: "candidates: CDE 942C20P27K / Faratronic resonant PP" },
  "X1-4u7-530":        { status: "CLASS", spec: "4.7 uF 530 VAC X1 safety film (E43 CX2 rev)", note: "Faratronic/Songtian/Vishay 3386 X1 families" },
  ...
  "CT-RES-1:100-80A":  { status: "DIRECT", spec: "resonant CT 1:100, 80 A class, 20-200 kHz pass-through (40 kW tank)", note: "Talema AS-family upsize RFQ; 140 kHz ratio/phase acceptance per pack" },
  "CT-RES-1:100-100A": { status: "DIRECT", spec: "resonant CT 1:100, 100 A class (50 kW tank; E60 F.11 145 A pk on 0.75 Ω)", note: "Talema AS-family upsize RFQ" },
  ...
  "R2512-1R6-2W-1%":   { status: "CLASS", spec: "1.6 R 1% 2 W 2512 (50 kW resonant burden — rail budget E42)", note: "Bourns CRM/Yageo SR anti-surge families" },
  ...
  "IND-TRIM-E70-40":   { status: "CUSTOM", spec: "D2-40 rev D (E60): 1x E70/33/32 gapped, N=5, bins 3.2/3.5/3.8 uH, litz 4150x0.071 — pack sheet" },
  "IND-TRIM-E70-50":   { status: "CUSTOM", spec: "D2-50 rev D (E60): 2x E70/33/32 gapped, N=3, bins 2.8/3.0/3.2 uH, litz 2500x0.1 — pack sheet" },
  "XFMR-LLC-2E70-40":  { status: "CUSTOM", spec: "D3-40 rev B (E51): 2x E70/33/32 sets, 6:6:6, B66372B2000 former — pack sheet" },
  "XFMR-LLC-2E70-50":  { status: "CUSTOM", spec: "D3-50 rev B (E51): 2x E70 sets, 5:5:5, web-bond — pack sheet" },
  "DM-CHOKE-30":       { status: "CUSTOM", spec: "D6-30 rev C: 2x T48 60u N=7 foil (engine) — pack sheet" },
