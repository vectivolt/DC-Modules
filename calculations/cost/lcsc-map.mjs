...
export const LCSC = {
  ...
  "CT-100A-1:2500":    { status: "REVIEW", note: "SUPERSEDED by ACX-1100 (audit 2026-09-08) — kept only so pre-regen sheets cross-check; do not order" },
  "CT-RES-1:100":      { status: "REVIEW", note: "SUPERSEDED by AS-404 (audit 2026-09-08) — kept only so pre-regen sheets cross-check; do not order" },
  "ACX-1100":          { status: "REVIEW", note: "Talema line CT 2500:1/100 A/Ø14.6 window — catalog part, made at Talema Salem (India); not an LCSC line: buy Talema direct (Digi-Key ~$8 retail is not the volume price). Closes the custom line-CT REVIEW (audit)" },
  "AS-404":            { status: "REVIEW", note: "Talema resonant CT 1:100/50 A/20–200 kHz pass-through — catalog part via Talema India; alt Coilcraft CST2010-100L (SMT, 47 A — at its 40 K rise at 46 A rms, airflow-verify). Closes the custom resonant-CT REVIEW (audit)" },
  "HF167F-80A-M":      { lcsc: "C2757422",   status: "REVIEW" , note: "HF167F/24-HF 100 A@1000 VAC; mirror-contact variant to be confirmed — 2026-09-06 RESOLVED from the Hongfa HF167F datasheet: the auxiliary contact is an ORDERING OPTION. Code is HF167F <coilV> -H <aux> <constr> <material> <insul> (special), where the field after H is the AUXILIARY CONTACT ARRANGEMENT (A = 1 Form A, Nil = none). Aux is only offered on the 764 flux-proofed type. Part needed: HF167F/024-HATF(764) -- 24 V coil, main 1 Form A carrying 100 A / breaking 30 A @1000 VAC, auxiliary 1 Form A 1 A 12 VDC for weld detection, PCB termination, body 38x33x43 mm, main blades on 20 mm centres. This is what E30 calls the mirror contact. C2757422 (HF167F/24-HF) is the NON-auxiliary variant, which is why its land had no pads 5/6/8."},
  ...
  "HFE82V-20-M-CLASS": { status: "REVIEW", spec: "20 A 1000 VDC relay w/ auxiliary contact — pre-insertion",
