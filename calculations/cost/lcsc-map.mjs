...
export const LCSC = {
  ...
  "ELH-330u550":       { status: "CLASS", spec: "330 µF 550 V snap-in, 105 °C, −40 °C category (E67 bank electrolytic behind Lf)", note: "Jianghai CD29/CD294 · Aishi · ChengX" },
  "IND-BANK-30":       { status: "CUSTOM", spec: "D8-30 bank filter inductor (E67): D6-30 construction at DC duty — 2× T48 60µ sendust, N=7, foil 20 mm²" },
  "IND-BANK-40":       { status: "CUSTOM", spec: "D8-40 bank filter inductor (E67): D6-40 construction at DC duty — 2× T57 60µ sendust, N=8, foil 26.4 mm²" },
  "IND-BANK-50":       { status: "CUSTOM", spec: "D8-50 bank filter inductor (E67): D6-50 construction at DC duty — 3× T57 60µ sendust, N=8, foil 26.4 mm²" },
  ...
  "RELAY-PCB-120A-24V": { status: "DIRECT", spec: "PCB power relay 120 A, 24 V coil, zero-current S/P matrix duty (E67, 30/40 kW)", note: "Hongfa HF161F / Churod CHC-D120 class" },
  "RELAY-PCB-150A-24V": { status: "DIRECT", spec: "PCB power relay 150 A, 24 V coil, zero-current S/P matrix duty (E67, 50 kW)", note: "Hongfa / Churod 150 A class" },
  ...
  "XFMR-LLC-CELL-2E70-30": { status: "CUSTOM", spec: "D3-30 rev D (E67): full-bridge transformer cell, 2x E70/33/32, 6:6||6, B66372B2000 former, Lm 28 µH/cell ±7% — pack sheet" },
