...
export const LCSC = {
  ...
  "CT-LINE-2500-150A": { status: "DIRECT", spec: "line CT 2500:1, 150 A class, 4 kV hipot (50 kW; 187 A pk observability)", note: "Talema ACX-family upsize RFQ (Salem India); burden 21.5 R on PCB" },
  ...
  "CT-RES-1:100-100A": { status: "DIRECT", spec: "resonant CT 1:100, 100 A class (50 kW tank; OC 95 A pk)", note: "Talema AS-family upsize RFQ" },
  ...
  "IND-TRIM-BIN5-40":  { status: "CUSTOM", spec: "D2-40: 2x PQ50/50 gapped, N=5, bins 3.2/3.5/3.8 uH, litz 2000x0.1 — pack sheet" },
  "IND-TRIM-BIN6-50":  { status: "CUSTOM", spec: "D2-50: N=6, bins 2.8/3.0/3.2 uH, litz 3000x0.1 — pack sheet" },
