...
export const DB = [
  ...
  { m: /^RNS[123][AB]$/, mpn: "R2512-47k-HV-AS", mfr: "KOA/UniOhm", desc: "47 kOhm 2512 2 W anti-surge HV, Umax >= 250 V, 2-series per position (artificial-star network)", price1k: 3.2, alt: "any HV anti-surge" },
...
export const skuOverrides = {
  ...
  "50kw": {
    ...
    T1A: { price1k: 1434, mpn: "XFMR-LLC-CELL-3E70-50", note: "D3-50 rev D (E67): the D3-40 rev D cell construction (3× E70, 4:4∥4, litz 3536×0.071, 2 × 0.10 mm foil halves) at the 50 kW duty — plate-bonded on the liquid SKU (hot-spot 102 °C), web-bonded on air (117 °C). Roll-up ₹1,434 [est]" },
