...
export const DB = [
  ...
  { m: /^D[ABC]\d+[TB]$/, mpn: "SICJBS-1200-40", mfr: "SiChain", desc: "SiC JBS 1200 V 40 A-class TO-247-2 REQUIREMENT (exact p/n at RFQ; IFSM ≥ 250 A (10 ms half-sine, 25 °C) — E73 bypass-closure surge. E80/HR-03: the GC4D20120D candidate is NOT this part — mfr data shows TO-247-3, dual-die common-cathode, 16.5 A/leg at Tc 135 °C, IFSM 71 A/leg — ordering FROZEN until a true 2-terminal ≥40 A part or a deliberate dual-die redesign with a 3-pin footprint is selected)", price1k: 120, alt: "BASiC B3D040120H" },
  ...
  // one that was not.
  { m: /^PS\d+[HL]$/, overrides: ["ISO5V-RFC-6K"], mpn: "QA01C-18", mfr: "MORNSUN", desc: "iso gate-bias module +18/−3 V (catalogue QA01C-18 — O-11 CLOSED at E45, reconfirmed E80 against the MORNSUN datasheet: models and DPT run the real −3 V off-bias; B3M010C075Z conditional gate floor is −5 V so −3 V keeps 2 V of undershoot room, verify at DPT. E23 rev B: modules PERMANENT at ≥10k/yr, ≤₹55 p10k; R5-F: DC input 13.5–16.5 V vs V15 ≈15.0 V — inside range, cross-regulation re-verify at EVT)", price1k: 95, p10k: 55, alt: "domestic iso-module eq (2nd source at RFQ)" },
