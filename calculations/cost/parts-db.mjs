...
export const DB = [
  ...
  { m: /^QDIS[FAB]$/, mpn: "SIC-1200-5A", mfr: "CR Micro", desc: "SiC FET 1200 V 5 A (bus discharge QDISF / bank bleeders QDISA-B, HR-15; R7-B gate spec for the PV-driven bleeders: Vth(max) ≤ 3.5 V, Igss ≤ 100 nA — the VOM1271 guaranteed chord delivers ≥5.8 V at 6.8 MΩ)", price1k: 120, alt: "BASiC small 1200V" },
