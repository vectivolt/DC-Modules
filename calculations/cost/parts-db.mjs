...
export const DB = [
  ...
  { m: /^PSQD\w*$/, mpn: "QA01C-15S18", mfr: "MORNSUN", desc: "iso 15→18 V module ≥6 kVDC (bus-discharge driver bias, CB-11; insulation cert class §K)", price1k: 95, p10k: 60, alt: "B1518S-3WR3HD" },
  ...
  { m: /^USUP[AB]$/, mpn: "TPS3430-class", mfr: "TI/eq", desc: "external windowed watchdog SOT-23-6: VDD/GND/WDI/WDO/SET straps (HR-13 — symbol now carries supply + window pins; strap values per datasheet at A6/§K)", price1k: 35, alt: "MAX6753" },
  ...
  // --- control
  { m: /^U(PFC|LLC)$/, mpn: "GD32G553VET6", mfr: "GigaDevice", desc: "MCU Cortex-M33 216 MHz LQFP100 (MR-12: V-suffix = 100-pin — the earlier RET6 was the 64-pin part; full pin map regenerates at A6)", price1k: 210, alt: "GD32G563" },
  ...
  { m: /^UAUX$/, mpn: "NCP1252A", mfr: "onsemi", desc: "current-mode flyback controller, fixed 65 kHz, BO pin, VCC-resistor startup, SOIC-8 — MR-13: the drawn application IS this IC; the previously-priced UCC28C43 has no BO pin and needs an RT/CT network the schematic never drew", price1k: 24, alt: "UCC28C43 + RT/CT & BO rework" },
  { m: /^UBK[AB]$/, mpn: "TPS54202-class", mfr: "TI/eq", desc: "15→3.3 V 2 A sync buck SOT-23-6 (CB-17/18 — replaces the thermally-impossible 15 V-fed LDO; one per board)", price1k: 15, alt: "MP2451/SY8113" },
  { m: /^LBK[AB]$/, mpn: "IND-10u-3A", mfr: "any shielded", desc: "10 µH 3 A shielded power inductor (3V3 buck)", price1k: 6, alt: "any" },
  ...
  { m: /^L\d+T$/, mpn: "IND-TRIM-BIN4", mfr: "custom (D2 rev B)", desc: "resonant trim BIN SET 3.3/3.65/4.0/4.35 µH ±3% — bin picked against measured transformer leakage so Lr(total)=7.0 µH (CB-22: the single 4.3 µH p/n was the pre-MC rev-A part; kitting per DFM step 3)", price1k: 85, alt: "air-core option" },
  ...
  { m: /^CMC[12]$/, mpn: "CMC-3PH-2mH-SKU", mfr: "custom/Hongfa mag", desc: "3-phase CM choke 2 mH nanocrystalline, line-current-rated winding per SKU (HR-18/drawing D7: the family-wide 4 mm² wire ran 14–28 A/mm²; foil/busbar wound at 60/120 kW, ΔT ≤ 45 K acceptance)", price1k: 240, alt: "sendust CM" },
  ...
  { m: /^(RBAL[TB]\w*|RNS[123][AB])$/, mpn: "R2512-47k-HV-AS", mfr: "KOA/UniOhm", desc: "47 kΩ 2512 anti-surge HV type, used 2-series per position (HR-20: halves per-element V and W — ≤208 V / ≤0.92 W continuous)", price1k: 4, alt: "any HV 2512" },
  ...
  { m: /^R\w+(B|CT)$/, mpn: "R1206-33R-1%", mfr: "any", desc: "33 Ω CT burden 1% (line CTs 1:2500 → 0.79 V/55 A)", price1k: 1.5, alt: "any" },
...
export const skuOverrides = {
  ...
  "120kw": {
    ...
    RPRE1: { price1k: 45, note: "50 W pulse variant (477 J/event — HR-14)" }, RPRE2: { price1k: 45 },
    RDIS0: { price1k: 45, note: "50 W pulse variant (382 J — HR-14)" }, RDIS1: { price1k: 45 }, RDIS2: { price1k: 45 }, RDIS3: { price1k: 45 },
    RSHO: { price1k: 260 },
  },
};
