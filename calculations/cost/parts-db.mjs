...
export const DB = [
  ...
  { m: /^CT[ABC]\d+$/, mpn: "CT-100A-1:2500", mfr: "ZEMCT/eq", desc: "line CT 100 A class (R3: 63.95 A rms/cell at 285 V low line exceeds a 60 A nameplate continuously; burden 33->27 R) (E18)", price1k: 65, alt: "HCT series" },
  ...
  { m: /^R[ABC]\d+B$/, mpn: "R1206-33R-1%", mfr: "any", desc: "33 Ω CT burden 1% (line CTs 1:2500 → 0.79 V/55 A)", price1k: 1.5, alt: "any" },
