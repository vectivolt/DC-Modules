...
export const SECTIONS = {
  ...
  acdc: [
    ...
    ["AUX 110 W FLYBACK + 3V3 + RAIL MONITORS", /^(UAUX|QAUX|RAUX\w*|RCSF|CCSF|TAUX|DAUX\w*|CAUX\d\d|CVCC|DTVS\d\d|RBR\w+|RFB[12]|RCOMP|CCOMP|DCLA|CCLA|RCLA[123]|UBKA|LBKA|CBKIA|CBKOA|CBSTA|RBKF[12]A|RM(24|15)[AB])$/],
    ["COIL DRIVER", /^UPA$/],
    ["FANS", /^(JFAN\d|RFT\d)$/],
...
export const SHEET_IDENT = {
  "30kw/acdc":  { sku: "30 kW", board: "AC-DC (lower)", sheet: "1 of 3", cells: "Vienna PFC: 1x 750 V SiC die per position, D1 3x T79 N=39, 10-can link, 2 fans (E68/E69)" },
  "30kw/dcdc":  { sku: "30 kW", board: "DC-DC (upper)", sheet: "2 of 3", cells: "full-bridge LLC: 1x SG2M023120LJ per position, 7x33 nF + D2 rev F, 2 cells, film banks 9x2.2 uF, DOUT (E67/E68)" },
  ...
  "40kw/dcdc":  { sku: "40 kW", board: "DC-DC (upper)", sheet: "2 of 3", cells: "full-bridge LLC: 2x SG2M023120LJ per position, 9x33 nF + D2 rev F, 2 cells, film banks 12x2.2 uF, DOUT (E67/E68)" },
  ...
  "50kw/dcdc":  { sku: "50 kW liquid", board: "DC-DC (upper)", sheet: "2 of 3", cells: "full-bridge LLC: 2x SG2M023120LJ per position, 11x33 nF + D2 rev F, 2 cells, film banks 14x2.2 uF, DOUT (E67/E68)" },
