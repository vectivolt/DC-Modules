...
export const PAGES = [
  ...
  ["docs/assumptions.md", "platform", "📒", "Decision Register", "Every frozen decision E1–E79, why it was taken, and the evidence that holds it", "LIVE_SPEC", [["gate", "stress--audit_·_review--checks", "2ea44f"]]],
  ...
  ["docs/firmware-guide.md", "platform", "💾", "Firmware Guide", "The supervisory C99 core — state machine, fault ladder, HAL contract and the host-proven test suite", "LIVE_SPEC", [["firmware", "114_·_18_·_40_ASan%2FUBSan", "2ea44f"]]],
  ["docs/firmware-architecture.md", "platform", "🧬", "Firmware Architecture", "Layers, timing, state machines, control and ramping, the protection hierarchy and exception handling — and the review that shaped them", "LIVE_SPEC", [["review", "E78_·_25_findings", "d19a00"]]],
  ...
  ["docs/evt-plan.md", "verification", "🔬", "EVT Test Plan", "The first-hardware campaign T-00…T-49, and the rule that lets bench results reopen a calculation", "LIVE_SPEC"],
  ["docs/firmware-verification.md", "verification", "🧪", "Firmware Verification Plan", "Every firmware feature as behaviour, timing, failure, recovery, test and pass criterion — host, HIL, fuzzing, conformance and endurance", "LIVE_SPEC", [["host", "222_checks_·_ASan%2FUBSan", "2ea44f"]]],
