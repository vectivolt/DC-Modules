...
export const PAGES = [
  ...
  ["docs/assumptions.md", "platform", "📒", "Decision Register", "Every frozen decision E1–E61, why it was taken, and the evidence that holds it", "LIVE_SPEC", [["gate", "stress--audit_·_review--checks", "2ea44f"]]],
