...
export const PAGES = [
  ...
  ["docs/assumptions.md", "platform", "📒", "Decision Register", "Every frozen decision E1–E73, why it was taken, and the evidence that holds it", "LIVE_SPEC", [["gate", "stress--audit_·_review--checks", "2ea44f"]]],
  ...
  ["docs/firmware-guide.md", "platform", "💾", "Firmware Guide", "The supervisory C99 core — state machine, fault ladder, HAL contract and the host-proven test suite", "LIVE_SPEC", [["host__sim", "63%2F63_ASan%2FUBSan", "2ea44f"]]],
  ...
  ["docs/evt-plan.md", "verification", "🔬", "EVT Test Plan", "The first-hardware campaign T-00…T-42, and the rule that lets bench results reopen a calculation", "LIVE_SPEC"],
