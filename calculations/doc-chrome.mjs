...
export const PAGES = [
  ...
  ["docs/firmware-guide.md", "platform", "💾", "Firmware Guide", "The supervisory C99 core — state machine, fault ladder, HAL contract and the host-proven test suite", "LIVE_SPEC", [["firmware", "353_checks_ASan%2FUBSan", "2ea44f"]]],
  ...
  ["docs/firmware-verification.md", "verification", "🧪", "Firmware Verification Plan", "Every firmware feature as behaviour, timing, failure, recovery, test and pass criterion — host, HIL, fuzzing, conformance and endurance", "LIVE_SPEC", [["host", "353_checks_·_ASan%2FUBSan", "2ea44f"]]],
  ...
  ["docs/benchmark-infypower-teardown.md", "production", "🩻", "InfyPower Teardown Benchmark", "Block-by-block audit of our architecture against the REG1K0135A2 40 kW SiC module teardown", "LIVE_SPEC", [["source", "chargerlab_·_read_2026--09--13", "8b949e"], ["verdict", "architecture_and_BOM_cloned_·_cost_gap_open", "d19a00"]]],
];
