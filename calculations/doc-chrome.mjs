...
export const PAGES = [
  ...
  ["docs/assumptions.md", "platform", "📒", "Decision Register", "Every frozen decision E1–E62, why it was taken, and the evidence that holds it", "LIVE_SPEC", [["gate", "stress--audit_·_review--checks", "2ea44f"]]],
  ...
  ["docs/lcsc-status.md", "production", "🔎", "LCSC Assignment Status", "Which parts carry an orderable LCSC number, which deliberately do not, and the lines still open before release", "LIVE_SPEC", [["sheets", "2662_instances_·_67%25_C--number", "2ea44f"], ["gate", "bom--maturity_·_MATURE", "2ea44f"]]],
  ...
  ["docs/benchmark-infypower-teardown.md", "production", "🩻", "InfyPower Teardown Benchmark", "Block-by-block audit of our architecture against the REG1K0135A2 40 kW SiC module teardown", "LIVE_SPEC", [["source", "chargerlab_·_read_2026--09--13", "8b949e"], ["verdict", "no_architecture_change_·_R18", "2ea44f"]]],
