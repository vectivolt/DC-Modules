...
export const PAGES = [
  ...
  ["docs/firmware-guide.md", "platform", "💾", "Firmware Guide", "The supervisory C99 core — state machine, fault ladder, HAL contract and the host-proven test suite", "LIVE_SPEC", [["firmware", "336_checks_ASan%2FUBSan", "2ea44f"]]],
  ...
  ["docs/firmware-verification.md", "verification", "🧪", "Firmware Verification Plan", "Every firmware feature as behaviour, timing, failure, recovery, test and pass criterion — host, HIL, fuzzing, conformance and endurance", "LIVE_SPEC", [["host", "336_checks_·_ASan%2FUBSan", "2ea44f"]]],
