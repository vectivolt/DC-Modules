...
export const PAGES = [
  ...
  ["docs/assumptions.md", "platform", "📒", "Decision Register", "Every frozen decision E1–E78, why it was taken, and the evidence that holds it", "LIVE_SPEC", [["gate", "stress--audit_·_review--checks", "2ea44f"]]],
  ...
  ["docs/firmware-verification.md", "verification", "🧪", "Firmware Verification Plan", "Every firmware feature as behaviour, timing, failure, recovery, test and pass criterion — host, HIL, fuzzing, conformance and endurance", "LIVE_SPEC", [["host", "172_checks_·_ASan%2FUBSan", "2ea44f"]]],
